...
/*            boolean mUpdatesRequested = false;
    ...
    private class DetermineClosestZone extends AsyncTask<String, String, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            Log.d(TAG, "smallest distance found: " + smallDistanceIndex);
            for (int i = 0; i < tannoyZones.getLocations().size(); i++) {
                if (i != smallDistanceIndex) {
                    ...
                    BigDecimal normalConstant = (deltaY.multiply(midPointY).subtract(deltaX.multiply(midPointX))).negate();
        ...
        protected void onPostExecute(Integer smallestDistanceIndex) {
            ...
            for (int i = 0; i < tannoyZones.getLocationNames().size(); i++) {
                locationNames.add(tannoyZones.getLocationNames().get(i));
            }
            ...
            ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(mainActivity, android.R.layout.simple_spinner_item, locationNames);
